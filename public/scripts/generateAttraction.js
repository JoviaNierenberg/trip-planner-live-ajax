// calls the functions that add and erase markers from the map
// lists items in the itinerary and deletes items from the itinerary

var generateAttraction;

$(document).ready(function () {
	// config is a set of things that are different between attraction types
